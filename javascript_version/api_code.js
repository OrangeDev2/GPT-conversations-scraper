...
app.get('/', (req, res) => {
  const url = 'https://chat.openai.com/share/[id]'; // Put your Chat Share Link.  ChatGPT, Poe AI Chat, or Bing AI Chat.  Bing AI Chat Share feature is available on Microsoft Edge Browser or in Edge App.
